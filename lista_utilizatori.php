...
<head>
    ...
    <title>Listare Utilizatori - LManager</title>
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="utilizatori">
									...
									while ($row = mysqli_fetch_assoc($query)) {
										...
										echo '<td>';
										if($status == "v"){
											echo '<span class="label label-warning">In validare</span>';
										} else if($status == "a"){
										...
										//rank
										echo '<td>'.$rank.'</td>';
										echo '<td><a href="edit_user.php?user='.$rank.'"><span class="glyphicon glyphicon-pencil"></span> Editeaza</td>';
									}
